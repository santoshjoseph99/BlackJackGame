...
class BlackjackGame {
    ...
    getAvailableActions(player) {
        ...
        if (!hand_1.default.checkHandBust(handValues)) {
    ...
    step5() {
        if (hand_1.default.isNatural(this.dealer.cards)) {
            ...
            this.getValidPlayers().forEach(p => {
                var _a;
                while (true) {
                    const result = p.cb && p.cb({ action: actions_1.default.playHand, availableActions: this.getAvailableActions(p) });
                    switch ((_a = result) === null || _a === void 0 ? void 0 : _a.action) {
                        ...
                        case actions_1.default.hit:
                            ...
                            p.cb && p.cb({ action: actions_1.default.playerCardUp, card: cardHit });
                            this.tableActions.next({ action: actions_1.default.playerCardUp, card: cardHit, player: p });
